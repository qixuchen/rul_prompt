...
class CMPDataIter(data.IterableDataset):
    ...
    def _process(self, train_df, test_df, test_truth):
        ...
        # train_df['setting2'] = train_df['setting2'].round(1)
        # train_df['setting3'] = train_df['setting3'].round(1)
        # train_df.iloc[:,5:] = train_df.iloc[:,5:].round(2)
        ...
        # test_df['setting2'] = test_df['setting2'].round(1)
        # test_df['setting3'] = test_df['setting3'].round(1)
        # test_df.iloc[:,5:] = test_df.iloc[:,5:].round(2)
