...
Based on data_loader_v2.py,
add feature vectore extrated from CLIP based on prompt
By Ruibing 2023.09.04
"""
import os
import csv
import random
...
class CMPDataIter(data.IterableDataset):
    ...
    def _process(self, train_df, test_df, test_truth):
        ...
        # print(f'type of train x: {type(train_x)}')
        # print(f'shape of train x: {len(train_x)}')
        
        return train_x, train_ops, train_y, test_x, test_ops, test_y, train_pmpt1, test_pmpt1

    def generate_prmpts(self, labels):
        pmpt1 = [self.pmpt_1[int(x[0] * self.max_rul)] for x in labels]
        # print(pmpt1)
        # print(len(pmpt1))
        # print(pmpt1[0].shape)
        return pmpt1
    ...
    def load_prompt(self, pmpt_path):
        ...
        pmpt_1 = pickle.load(open(pmpt_pt1, 'rb'))
    ...
    def reset(self, mode):
        ...
        if mode == 'train':
            ...
            train_prmpt1 = list(self.folded_train_prmpt1)
            ...
            self.cross_val_prompt1 = train_prmpt1.pop(val_fold_ind)
            ...
            self.cross_train_prompt1 = train_prmpt1[0] + train_prmpt1[1] + train_prmpt1[2] + train_prmpt1[3]
            ...
            self.out_prompt1 = self.cross_train_prompt1
            ...
            self.out_prompt1 = self.cross_val_prompt1
            ...
            self.out_prompt1 = self.test_pmpt1
    ...
    def __iter__(self):
        ...
        sum_iter = zip(out_x, out_ops, out_y, out_prompt1)
