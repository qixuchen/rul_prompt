...
from core.model_fed_baseline import model
...
if __name__ == "__main__":
	...
	metrics = metrics = metric.MetricList(metric.RMSE(max_rul = config.data.max_rul), metric.RULscore(max_rul = config.data.max_rul),)
